...
class Extractor:
    ...
    def __init__(self, today):
        ...
        self.today = today
        self.S3_BUCKET = self.resource.Bucket('sb-de-c3')
    ...
    def extract_csv(self, info):
        ...
        try:
            ...
            self.S3_BUCKET.upload_file(f'/tmp/{info[0]}.csv', f'{self.FOLDER}place2017/{info[0]}.csv')
    ...
    def extract_gzip(self, info):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.S3_BUCKET.upload_file(f'/tmp/{info[0]}.csv', f'{self.FOLDER}place2022/{info[0]}.csv')
